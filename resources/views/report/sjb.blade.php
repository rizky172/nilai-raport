            ...
            <td class="text-left" width="50%">
                <table width="100%" class="address" cellspacing="0">
                    <tbody>
                        ...
                        <tr><td width="80px"><b>No. SJB</b></td><td width="20px">:</td><td>{{ $ref_no }}</td></tr>
                        <tr><td width="80px"><b>No. Ref</b></td><td width="20px">:</td><td>{{ $ref_no_customer }}</td></tr>
...
@if (array_key_exists($gKey + 1, $detail))
